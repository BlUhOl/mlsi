...
const feedback = () => {
  return (
    <main>
    <_navbar/>
    <div className='ml-72  bg-emerald-950'>
      <div className=' w-full h-screen p-10'>
        <div className='flex bg-emerald-200  rounded-xl p-3 border-2 border-emerald-300 mb-3 bg-gradient-to-r from-emerald-300 to-emerald-50 shadow-lg'>
          <h1 className='text-3xl container font-medium text-emerald-950'>Feedback</h1>
        ...
        <div className='shadow-xl border-2 border-emerald-700 rounded-lg w-auto'>
          <iframe className='w-[1550px] h-[720px] p-1' src="https://docs.google.com/spreadsheets/d/15Yrp67o6B00AbYAkcUIEvhaOUrEJDQZ_kTq4Itk4IE0/edit?usp=sharing&amp;rm=minimal&amp;single=true&amp;headers=false"></iframe>
        </div>
